...
public final class SequenceGroup extends Sequence
{
	...
	/**
	 * 添加一个{@link Sequence}到序列组, 这个方法只能在初始化的时候调用;
	 * 运行时添加的话，使用{@link SequenceGroup#addWhileRunning(Cursored, Sequence)}
	 *
    ...
    /**
	 * 将序列组中出现的第一个给定的{@link Sequence}移除
	 *
